...
<section style="font-family: Arial, sans-serif; line-height:1.45;">
  <!-- INTRO / RESUMEN -->
  <h3>Execution Evidence — Resumen de lo alcanzado (Sprint 2)</h3>
  <p style="margin-top:0;">
  ...
  <p style="margin:0 0 10px 0; color:#555;">
    A continuación se muestran capturas de las vistas clave. Reemplaza los atributos <code>src</code> por las URLs o rutas reales de las imágenes generadas
    en tu repositorio o drive (por ejemplo: <code>/assets/screenshots/login.png</code>).
  </p>
  <div style="display:flex; flex-wrap:wrap; gap:12px; margin-bottom:12px;">
    ...
    <figure style="width:320px; margin:0;">
      <img src="imagesChapter05/entradanumero.jpeg" alt="Phone entry — US36" style="width:100%; border:1px solid #ddd; display:block;" />
      <figcaption style="padding:6px 0 0 0;">
    ...
    <figure style="width:320px; margin:0;">
      <img src="imagesChapter05/otp.jpeg" alt="OTP entry — US37" style="width:100%; border:1px solid #ddd; display:block;" />
      <figcaption style="padding:6px 0 0 0;">
