...
| ![Eduardo](./imagesTeam/Eduardo.png) | **Eduardo Fabián Chacaliaza Minaya (U202324129)** | **Frontend & UX/UI Engineer (PrimeVue / Figma)** | Dirige el diseño de la interfaz y la experiencia de usuario. Responsable de la creación del **design system**, la accesibilidad (**a11y**) y la internacionalización (**i18n**, en_US/es_419). Utiliza **Figma** y **PrimeVue** para garantizar consistencia visual. <br>**Evidencia TB1:** diseño inicial del Landing Page y lineamientos visuales aplicados al prototipo. |
